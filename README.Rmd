...
The R package `collinear` provides a comprehensive toolkit for smart multicollinearity management in datasets with mixed variable types. The main function, [collinear()], integrates five core components to handle multicollinearity across numeric and categorical predictors while protecting important predictors:
