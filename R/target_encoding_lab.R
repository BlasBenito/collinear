...
#'   \item "mean": Returns the mean of the response for each group in the categorical variable. This option accepts the argument "white_noise" to limit potential overfitting. The variables returned by this method are named with the suffix "__encoded_mean". This method is implemented in the function [target_encoding_mean()].
