...
#'
#' @description
#' Internal function to select a proper f_...() function to compute preference order depending on the types of the response variable and the predictors. The selection criteria is available as a data frame generated by [f_default_rules()].
#'
#'
...
f_default <- function(
  ...
  if(response_type == "unknown"){
    stop(
      "collinear::f_default(): response type is 'unknown', please select an f_...() function suitable for your response data.",
      call. = FALSE
    )
  }
  ...
  if(predictors_type == "unknown"){
    stop(
      "collinear::f_default(): predictors type is 'unknown', please select an f_...() function suitable for your predictor data.",
      call. = FALSE
    )
  }
...
#'
#' @description
#' Data frame with rules used by [f_default()] to select the function `f` to compute preference order in [preference_order()].
#'
#'
#' @return data frame
#' @family preference_order_tools
