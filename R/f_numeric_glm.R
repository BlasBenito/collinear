...
#'
#' @description
#' Fits a Gaussian GLM model \code{y ~ x} with the numeric response \code{y} and the numeric, character, or factor predictor \code{x} using [stats::glm()] and returns the R-squared of the observations against the predictions (see [score_r2()]).
#'
