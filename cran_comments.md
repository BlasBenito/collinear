...
- Linux (r-devel): 1 ERROR
  ...
  - This originates from the system toolchain on the rhub platform and
    is unrelated to the ‘collinear’ package.

All other tested platforms (macOS x86_64, macOS arm64, Windows, Linux
GCC/Clang variants, ASAN, MKL, noLD, noSuggests, atlas, intel, gcc13/14,
clang16–19, ubuntu-gcc/clang, ubuntu-release, ubuntu-next) completed
...
This is a major release with substantial API updates and new
functionality.
...
- [`collinear()`](https://blasbenito.github.io/collinear/reference/collinear.md)
  now returns structured `collinear_output` and `collinear_selection`
  objects.
