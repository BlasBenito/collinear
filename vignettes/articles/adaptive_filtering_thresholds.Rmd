...
For this article we need the following packages and configuration.
...
Where:
 ...
 - `0.493`: floor of the curve, corresponding to VIF ≈ 2.5 (conservative filtering).
 - `0.735`: ceiling of the curve (0.545 + 0.24), corresponding to VIF ≈ 7.5 (permissive filtering).
...
m <- mgcv::gam(
  ...
  weights = experiment_cor_vs_vif$selection_similarity^2,
