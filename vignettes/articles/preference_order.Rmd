...
This functionality is implemented in the function [preference_order()], which can take advantage of a parallelization backend to speed-up operations. Let's take a look at how it works, step by step. Let me start with the simplest approach.
